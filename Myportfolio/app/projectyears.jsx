      ...
      <div className='grid grid-cols-1 sm:grid-cols-2'>
        <div className='border-[1px] border-[#F3D1BF] rounded-tl-[6px] rounded-bl-[6px] p-[48px]'>
          <div className='flex items-center  break-words'>
            ...
            <div>
                <div className='text-[24px] pl-[24px] font-Epilogue font-bold text-[#391400]'>
                    1 +
                </div>
                <div className='pl-[24px] mt-[13px] text-[#391400] text-[20px] font-Epilogue break-words break-all'>
                   Year of experience
                </div>
            </div>
          </div>
        ...
        <div className='border-[1px] border-[#F3D1BF] rounded-tr-[6px] rounded-br-[6px] p-[48px]'>
          <div className='flex items-center'>
            ...
            <div>
                ...
                <div className='pl-[24px] mt-[13px] text-[#391400] text-[20px] font-Epilogue'>
                   Projects Done
                </div>
            </div>
